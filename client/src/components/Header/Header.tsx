    ...
    return <header>
        ...
        <div className={classes.div}>
            <Link to='/login'>Про школу</Link>
              ...
              <Link to='/login'>Військово-патріотичний гурток «ДЖУРА»</Link>
        ...
        <div className={classes.div}>
            <Link to='/login'>Прозорість та інформаційна відкритість</Link>
            <Link to='/login'>Фінансово-господарська діяльність</Link>
        ...
        <div className={classes.div}>
            <Link to='/login'>Батькам майбутніх першокласників</Link>
        ...
        <h1>Педагогам</h1>
        <div className={classes.div}>
            <Link to='/login'>Професійні спільноти вчителів</Link>
            <Link to='/login'>Атестація педагогів</Link>
            <Link to='/login'>Курси підвищення кваліфікації</Link>
        ...
        {isAdmin&&
         <Link to='/AdminPanel'>Адмін панель</Link>}
